...
<aside class="lg:col-span-1 animate-fadeIn" style="animation-delay: 0.4s;">
    <div class="bg-white p-4 rounded-lg shadow">
        <h2 class="text-xl font-semibold text-blue-900 mb-4 border-b-2 border-black-200 pb-2">Hot News 🔥</h2>
        <div id="hot-news-list" class="space-y-4">
            ...
            <div class="hot-news-item flex items-start space-x-3 group">
                <img src="./upload/<?= htmlspecialchars($item['image']) ?>" alt="Thumbnail"
                    class="w-20 h-20 object-cover rounded-md border border-blue-100 group-hover:opacity-80">
                <div>
                    <a href="index.php?page=respon&slug=<?= urlencode($item['slug']) ?>"
                        class="hot-news-title text-sm font-semibold text-black hover:text-blue-700 leading-tight block">
